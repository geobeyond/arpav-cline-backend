...
# 1. fd anomaly 30 year (model ensemble) (all year)
# 2. fd anomaly 30 year (other forecast models - no agree) (all year)
# 3. fd absolute annual (model ensemble) (all year)
# 4. fd absolute annual (other forecast models - no uncertainties) (all year)
...
def generate_forecast_coverage_configurations(
    ...
    return [
        ForecastCoverageConfigurationCreate(
            ...
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}an_0_"
        ...
        ForecastCoverageConfigurationCreate(
            ...
            netcdf_main_dataset_name="{climatic_indicator}",
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}_0_avg_"
                "{scenario}_ts19762100_ls_{spatial_region}.nc"
            ),
            wms_main_layer_name="{climatic_indicator}",
            spatial_region_id=spatial_region_ids["arpa_vfvg"],
        ...
        ForecastCoverageConfigurationCreate(
            ...
            netcdf_main_dataset_name="{climatic_indicator}",
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}_0_"
