...
# 1. tasmin anomaly 30 year (model ensemble)
# 2. tasmin anomaly 30 year (other forecast models - no agree)
# 3. tasmin absolute annual (model ensemble) (4 seasons)
# 4. tasmin absolute annual (other forecast models - no uncertainties) (4 seasons)
# 5. tasmin absolute annual (model ensemble) (all year)
# 6. tasmin absolute annual (other forecast models - no uncertainties) (all year)
