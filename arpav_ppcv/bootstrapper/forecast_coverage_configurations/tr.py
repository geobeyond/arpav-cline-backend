...
# 1. tr anomaly 30 year (model ensemble) (all year)
# 2. tr anomaly 30 year (other forecast models - no agree) (all year)
# 3. tr absolute annual (model ensemble) (all year)
# 4. tr absolute annual (other forecast models - no uncertainties) (all year)
...
def generate_forecast_coverage_configurations(
    ...
    return [
        ForecastCoverageConfigurationCreate(
            ...
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}an_20_avgagree_"
                "{time_window}_{scenario}_{spatial_region}.nc"
            ),
        ...
        ForecastCoverageConfigurationCreate(
            ...
            netcdf_main_dataset_name="{climatic_indicator}",
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}an_20_"
        ...
        ForecastCoverageConfigurationCreate(
            climatic_indicator_id=climatic_indicator_ids["tr-absolute-annual"],
            netcdf_main_dataset_name="{climatic_indicator}",
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}_20_avg_{scenario}_"
            ...
            lower_uncertainty_thredds_url_pattern=(
                ...
                "20_stddown_{scenario}_ts19762100_ls_{spatial_region}.nc"
            ),
            upper_uncertainty_thredds_url_pattern=(
                "{forecast_model_uncertainties_base_path}/eca{climatic_indicator}_"
                "20_stdup_{scenario}_ts19762100_ls_{spatial_region}.nc"
            ),
            scenarios=[
                ForecastScenario.RCP26,
                ForecastScenario.RCP45,
            ...
            observation_series_configurations=[
                observation_series_configuration_ids[
                    "tr-absolute-annual-arpa_v-yearly"
                ],
            ],
        ),
        ForecastCoverageConfigurationCreate(
            ...
            netcdf_main_dataset_name="{climatic_indicator}",
            thredds_url_pattern=(
                "{forecast_model_base_path}/eca{climatic_indicator}_20_"
