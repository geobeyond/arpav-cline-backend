...
def generate_climatic_indicators(
    ...
    return [
        ClimaticIndicatorCreate(
            name="pr",
            historical_coverages_internal_name="PRCPTOT",
            ...
            description_english="Cumulative precipitation near the ground",
            description_italian="Precipitazione cumulata vicino al suolo",
            unit_english="mm",
            unit_italian="mm",
            palette="default/seq-BuYl-inv",
            color_scale_min=0,
            color_scale_max=2800,
            data_precision=0,
            sort_order=9,
            observation_names=[
                ClimaticIndicatorObservationNameCreate(
